...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn(
                'tw:bg-background tw:group/calendar tw:p-3 tw:[--cell-size:--spacing(8)] tw:in-data-[slot=card-content]:bg-transparent tw:in-data-[slot=popover-content]:bg-transparent',
