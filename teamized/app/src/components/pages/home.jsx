                        ...
                        <div className="m-1">
                            ...
                            {canCollapseChangelog ? (
                                <a
                                    ...
                                    onClick={() => this.setState({changelogAmount: Math.max(5, this.state.changelogAmount - 3)})}
                            ...
                            {canExpandChangelog ? (
                                <a
                                    ...
                                    onClick={() => this.setState({changelogAmount: Math.min(CHANGELOG.length, this.state.changelogAmount + 3)})}
                                    style={{marginTop: "-0.75rem"}}
                                >
                                    Mehr anzeigen
                                </a>
