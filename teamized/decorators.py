        ...
        def wrap(*args, **kwargs):
            try:
                ...
                raise exceptions.ValidationError(
                    _(
                        "Integritätsfehler. Möglicherweise existiert ein Objekt mit denselben Daten (z. B. E-Mail-Adresse) bereits."
                    ),
                ...
                raise exceptions.ValidationError(
                    _(
                        "Beim Validieren der Daten ist ein Fehler aufgetreten. Sind die Daten korrekt?"
                    ),
