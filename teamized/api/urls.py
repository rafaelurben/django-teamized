...
urlpatterns = [
    ...
    path('teams/<team>/me/worksessions', ep.workingtime.endpoint_worksessions,
         name='api-workingtime-worksessions'),
    path('teams/<team>/me/worksessions/<session>', ep.workingtime.endpoint_worksession,
         name='api-workingtime-worksession'),
    path('me/worksessions/tracking/start/t=<team>', ep.workingtime.endpoint_tracking_start,
         name='api-workingtime-tracking-start'),
    path('me/worksessions/tracking/live', ep.workingtime.endpoint_tracking_live,
         name='api-workingtime-tracking-live'),
    path('me/worksessions/tracking/stop', ep.workingtime.endpoint_tracking_stop,
    ...
    path('teams/<team>/create-club', ep.club.endpoint_create_club,
         name='api-create-club'),
    path('teams/<team>/club', ep.club.endpoint_club,
         name='api-club'),
    path('teams/<team>/club/members', ep.club.endpoint_members,
         name='api-club-members'),
    path('teams/<team>/club/members/<member>', ep.club.endpoint_member,
         name='api-club-member'),
    path('teams/<team>/club/members/<member>/portfolio', ep.club.endpoint_member_portfolio,
         name='api-club-member-portfolio'),
    path('teams/<team>/club/members/<member>/create-magic-link', ep.club.endpoint_member_create_magic_link,
         name='api-club-member-create-magic-link'),
    path('teams/<team>/club/members/<member>/membership/<group>', ep.club.endpoint_member_groupmembership,
         name='api-club-member-group-membership'),
    path('teams/<team>/club/groups', ep.club.endpoint_groups,
         name='api-club-groups'),
    path('teams/<team>/club/groups/<group>', ep.club.endpoint_group,
         name='api-club-group'),
