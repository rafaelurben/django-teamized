...
const IconsColumnSkeleton = () => {
    return (
        <div className="tw:flex tw:flex-col tw:gap-2 tw:w-full">
            <Skeleton className="tw:h-4 tw:w-1/2 tw:rounded-md" />
            <div className="tw:grid tw:grid-cols-5 tw:gap-2 tw:w-full">
...
>(
    (
            ...
            (icon: IconData) => (
                <TooltipProvider key={icon.name}>
                    <Tooltip>
                        <TooltipTrigger
                            className={cn(
                                'tw:p-2 tw:rounded-md tw:border tw:hover:bg-foreground/10 tw:transition',
        ...
        const renderVirtualContent = useCallback(() => {
            ...
            return (
                <div
                    className="tw:relative tw:w-full tw:overscroll-contain"
                    style={{
                            ...
                            if (item.type === 'category') {
                                return (
                                    <div
                                        key={virtualItem.key}
                                        style={itemStyle}
                                        className="tw:top-0 tw:bg-background tw:z-10"
                                    >
                                        <h3 className="tw:font-medium tw:text-sm tw:capitalize">
                                            {
                                                categorizedIcons[
                                                    item.categoryIndex
                                                ].name
                                        ...
                                        <div className="tw:h-[1px] tw:bg-foreground/10 tw:w-full" />
                                    </div>
                                );
                            }
        ...
        return (
            ...
            >
                ...
                <PopoverContent className="tw:w-64 tw:p-2">
                    {searchable && (
                        <Input
                    ...
                    {categorized && search.trim() === '' && (
                        <div className="tw:flex tw:flex-row tw:gap-1 tw:mt-2 tw:overflow-x-auto tw:pb-2">
                            {categoryButtons}
                        </div>
                    )}
                    <div
                        ref={parentRef}
                        className="tw:max-h-60 tw:overflow-auto"
